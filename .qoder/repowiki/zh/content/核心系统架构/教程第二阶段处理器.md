...
## 更新摘要
**所做更改**
- 新增智能战斗检测功能章节，详细介绍模板匹配 fight_start.png 和 OCR 文本检测
- 更新双加载界面等待机制，增加战斗开始标志检测功能
...
**更新** 新增智能战斗检测功能，包括模板匹配 fight_start.png 和 OCR 文本检测（积分争夺/積分爭奪），以及增强的双加载界面等待机制，支持战斗开始标志检测。
...
**更新** 新增智能战斗检测功能，支持模板匹配 fight_start.png 和 OCR 文本检测（积分争夺/積分爭奪），以及增强的双加载界面等待机制，支持战斗开始标志检测。
...
**更新** 新增的智能战斗检测功能显著提升了系统的鲁棒性和适应性，能够在复杂的网络环境下准确识别战斗开始状态，减少不必要的等待时间。
