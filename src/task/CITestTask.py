...
class CITestTask(BaseTask):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.default_config = {
            ...
            'APK下载目录': 'packages',
            '游戏包名': ['com.dgames.g65002007.google', 'com.fivegames.g65002007.google'],
            'ADB端口': 5555,
            '模拟器实例索引': 0,
            '企业微信Webhook': '',
            '任务触发延迟(秒)': 60,
    ...
    def _load_config(self):
        ...
        self._ci_config = {
            ...
            'package_name': get_config('游戏包名', ['com.dgames.g65002007.google', 'com.fivegames.g65002007.google']),
